"""
Django settings for application_4 project.
...
ROOT_URLCONF = 'application_4.urls'
...
WSGI_APPLICATION = 'application_4.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "application Support <support@application-4.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "application_4 API",
    "DESCRIPTION": "API documentation for application_4 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "application_4.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "application_4.storage_backends.AzureStaticStorage"
